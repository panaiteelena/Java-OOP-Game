...
public class KeyManager implements KeyListener
{
    ...
    private final boolean[] lastKeys ; /*!< Vector de flaguri pentru toate tastele. Tastele vor fi regasite dupa cod [0 - 255]*/
    ...
    public boolean R;
    public boolean k;
    public boolean ESC;// Flag pentru tasta space apasata
    /*!< Flag pentru tasta "dreapta" apasata.*/
    ...
    public void Update()
    {
        // Copiem starea veche înainte de a o suprascrie
        ...
        ESC = keys[KeyEvent.VK_ESCAPE];// Actualizează flagul pentru tasta space
